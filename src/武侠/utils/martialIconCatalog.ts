...
import buddhistFingerUrl from '../assets/icons/jinyong/martial_buddhist_finger.webp?url';
import buddhistGuardUrl from '../assets/icons/jinyong/martial_buddhist_guard.webp?url';
import buddhistInnerUrl from '../assets/icons/jinyong/martial_buddhist_inner_gold.webp?url';
import bodyUrl from '../assets/icons/jinyong/martial_body.webp?url';
import fingerUrl from '../assets/icons/jinyong/martial_finger.webp?url';
import fistUrl from '../assets/icons/jinyong/martial_fist.webp?url';
import formationUrl from '../assets/icons/jinyong/martial_formation.webp?url';
import grappleUrl from '../assets/icons/jinyong/martial_grapple.webp?url';
import hiddenNeedleUrl from '../assets/icons/jinyong/martial_hidden_needle.webp?url';
import innerYangUrl from '../assets/icons/jinyong/martial_inner_yang.webp?url';
import innerYinUrl from '../assets/icons/jinyong/martial_inner_yin.webp?url';
import luohanFuhuUrl from '../assets/icons/jinyong/martial_luohan_fuhu.webp?url';
import palmUrl from '../assets/icons/jinyong/martial_palm.webp?url';
import palmDragonUrl from '../assets/icons/jinyong/martial_palm_dragon.webp?url';
import poisonUrl from '../assets/icons/jinyong/martial_poison.webp?url';
import qinggongUrl from '../assets/icons/jinyong/martial_qinggong.webp?url';
import qinggongWallUrl from '../assets/icons/jinyong/martial_qinggong_wall.webp?url';
import saberFireUrl from '../assets/icons/jinyong/martial_saber_fire.webp?url';
import saberForceUrl from '../assets/icons/jinyong/martial_saber_force.webp?url';
import soundUrl from '../assets/icons/jinyong/martial_sound.webp?url';
import spearUrl from '../assets/icons/jinyong/martial_spear.webp?url';
import staffUrl from '../assets/icons/jinyong/martial_staff.webp?url';
import swordForceUrl from '../assets/icons/jinyong/martial_sword_force.webp?url';
import swordFormationUrl from '../assets/icons/jinyong/martial_sword_formation.webp?url';
import swordSwiftUrl from '../assets/icons/jinyong/martial_sword_swift.webp?url';
import whipUrl from '../assets/icons/jinyong/martial_whip.webp?url';
