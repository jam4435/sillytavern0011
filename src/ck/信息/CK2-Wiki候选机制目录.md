...
| GOV-03 | 授予/剥夺头衔、转封封臣、授予荣誉头衔 | 土地和职位是对话中最有分量的筹码 | **保留 / P0**，必须有合法性校验与事件记录 | L | [外交行动](https://ck2.parawikis.com/wiki/%E5%A4%96%E4%BA%A4%E8%A1%8C%E5%8A%A8) |
...
| P0 | AI 行动与规则引擎分权 | EVT-02、06 | LLM 生成表达、有限关系调整和注册行动调用，规则自动提交合法结果 |
...
9. **承诺提交**：玩家在对话中明确接受给钱、给职、欠人情或未来授地后，规则引擎自动冻结/登记义务并显示协议记录。
